...
public class ExpertAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup arg2) {
        ...
        listItemView.title.setText(itemlists.get(position).getHisname());
        listItemView.brief.setText(itemlists.get(position).getIntroduce());
        listItemView.replay.setText(itemlists.get(position).getExpertlevelname());
        listItemView.assist.setText(itemlists.get(position).getSpecial());
        listItemView.date.setText(itemlists.get(position).getAreaname());
