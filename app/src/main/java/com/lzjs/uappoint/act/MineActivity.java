                    ...
                    new RequestCallBack<String>() {
                        ...
                        public void onSuccess(ResponseInfo<String> responseInfo) {
                            ...
                            if (object.getString("result").equals("200")) {
                                ...
                                myPhone.setText(name);
                                if ("00M".equals(sex)) {
                                    mySex.setText("男");
                                } else if ("00W".equals(sex)) {
                                    mySex.setText("女");
                                }
                            String imagePath=jsonData.getString("headPic");
                                ImageLoader.getInstance().displayImage(imagePath,myPic, DisplayUtil.getOptions());
                            }
    ...
    public boolean isLogin() {
        ...
        if (regiId.isEmpty()) {
            ...
            body_submit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    SharedUtils.putLoginUserId(MineActivity.this, "");
